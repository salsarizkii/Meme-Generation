...
CSV_COLUMNS = ["run_id", "timestamp", "template_id", "method", "language", "topic", "caption", "meme_url", "clip_score", "crossmodal_incongruity"]
...
def save_result_to_csv(template_id, method, language, topic, caption, meme_url, clip_score, incongruity_score):
...
def meme_pipeline_1(template_id, topic_key=None, language=None):
    ...
    save_result_to_csv(template_id, "zero", language, topic_display, cap_zero, meme_url, clip_score, incongruity_score)
...
def meme_pipeline_few(template_id, topic_key=None, language=None):
    ...
    save_result_to_csv(template_id, "few", language, topic_display, cap_few, meme_url, clip_score, incongruity_score)
...
if __name__ == "__main__":
    ...
    # Pastikan di server sudah: ollama pull llama4
